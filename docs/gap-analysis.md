...
*2026-03-09 — Protocol v0.14, post Era/JSON/evtctl migration*
...
- JSON attestation validation (evtctl complete checks contract coverage) — UC7 covers event logging but not the validation mechanic specifically
