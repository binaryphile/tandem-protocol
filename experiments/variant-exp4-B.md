# Tandem Protocol - Step 5 (Experiment 4, Variant B: Quote Requirement)
...
⚠️ REQUIRED: Before executing each sub-step, quote that sub-step's section verbatim.
Do not proceed from memory. Find and copy the actual text before executing.
